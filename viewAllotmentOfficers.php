<?php $pageTitle = "Allotment Officers";?>
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-2 mt-5 text-center">
                                <a class="btn btn-success" href="addNewAdmin.php" role="button">Add Allotment Officer</a>
                            </div>
                        </div>
                        <!-- <div class="col-md-3">
                            <div class="mb-2 mt-5 text-center">
                    ...
                    <div class="text-center mt-3 mb-2">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            if (isset($_GET["page"])) {
                                global $ConnectingDB;
                                $sql = "SELECT * FROM admins WHERE adminRole ='Super_Admin' ORDER BY id ";
                                ...
                                $sql = "SELECT * FROM admins WHERE adminRole = 'Super_Admin' ORDER BY id LIMIT $ShowPostFrom,10";
                        ...
                        <div class="col-lg-4 offset-lg-4 col-md-4 offset-md-4 col-sm-12 mt-4">
                            <nav>
                                <ul class="pagination pagination-lg">
                                        ...
                                        if ( $Page>1 ) {?>
                                    <li class="page-item">
                                        <a class="page-link text-dark" href="viewAllotMentOfficers.php?page=<?php  echo $Page-1; ?>">
                                        ...
                                        <?php
                                        global $ConnectingDB;
                                        $sql           = "SELECT COUNT(*) FROM admins WHERE adminRole ='Super_Admin'";
                                        $stmt          = $ConnectingDB->query($sql);
                                    ...
                                    <li class="page-item active">
                                        <a class="page-link bg-dark" href="viewAllotMentOfficers.php?page=<?php  echo $i; ?>"><?php  echo $i; ?></a>
                                    </li>
                                        <?php
                                        }else {
                                        ?>
                                    <li class="page-item">
                                        <a class="page-link" href="viewAllotMentOfficers.php?page=<?php  echo $i; ?>"><?php  echo $i; ?></a>
                                    </li>
                                        <?php  }
                                        } } ?>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link bg-dark text-white" href="viewAllotMentOfficers.php?page=<?php  echo $Page+1; ?>">
