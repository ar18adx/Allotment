...
$inspDetParameter = $_GET["tenantId"];
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            if (isset($_GET["page"])) {
                                ...
                                if($_SESSION["adminRole"] == "Super_Admin"){
                                    $sql = "SELECT * FROM inspectionreport WHERE tenantId = '$inspDetParameter' ";
                                }elseif($_SESSION["adminRole"] == "Site_Manager"){
                                    $sql = "SELECT * FROM inspectionreport WHERE tenantId = '$inspDetParameter' AND siteName = '$adminSiteName' ";
                                }
                                ...
                                if($_SESSION["adminRole"] == "Super_Admin"){
                                    $sql = "SELECT * FROM inspectionreport WHERE tenantId = '$inspDetParameter' ORDER BY id LIMIT $ShowPostFrom,10";
                                }elseif($_SESSION["adminRole"] == "Site_Manager"){
                                    $sql = "SELECT * FROM inspectionreport WHERE tenantId = '$inspDetParameter' AND siteName = '$adminSiteName' ORDER BY id LIMIT $ShowPostFrom,10";
                                }
                        ...
                        <div class="col-lg-4 offset-lg-4 col-md-4 offset-md-4 col-sm-12 mt-4">
                            <nav>
                                <ul class="pagination pagination-lg">
                                        ...
                                        if ( $Page>1 ) {?>
                                    <li class="page-item">
                                        <a class="page-link text-dark" href="viewTenantInspectionRecord.php?page=<?php  echo $Page-1; ?>">
                                        ...
                                        if($_SESSION["adminRole"] == "Super_Admin"){
                                            $sql           = "SELECT COUNT(*) FROM inspectionreport WHERE tenantId = '$inspDetParameter' ";
                                        }elseif($_SESSION["adminRole"] == "Site_Manager"){
                                            $sql           = "SELECT COUNT(*) FROM inspectionreport WHERE tenantId = '$inspDetParameter' AND siteName = '$adminSiteName' ";
                                        }
                                    ...
                                    <li class="page-item active">
                                        <a class="page-link bg-dark" href="viewTenantInspectionRecord.php?page=<?php  echo $i; ?>"><?php  echo $i; ?></a>
                                    </li>
                                        <?php
                                        }else {
                                        ?>
                                    <li class="page-item">
                                        <a class="page-link" href="viewTenantInspectionRecord.php?page=<?php  echo $i; ?>"><?php  echo $i; ?></a>
                                    </li>
                                        <?php  }
                                        } } ?>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link bg-dark text-white" href="viewTenantInspectionRecord.php?page=<?php  echo $Page+1; ?>">
