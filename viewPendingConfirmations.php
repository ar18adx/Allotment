                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        if (isset($_GET["page"])) {
                            ...
                            if($_SESSION["adminRole"] == "Super_Admin"){
                                ...
                                $sql = "SELECT * FROM waitinglist WHERE applicationStatus = 'Pending_Confirmation' AND siteCity = '$adminSiteName' ORDER BY id ASC";
                            }
                            ...
                            if($_SESSION["adminRole"] == "Super_Admin"){
                                ...
                                $sql = "SELECT * FROM waitinglist WHERE applicationStatus = 'Pending_Confirmation' AND siteCity = '$adminSiteName' ORDER BY id ASC LIMIT $ShowPostFrom,10";
                            }
                            ...
                            <ul class="pagination pagination-lg">
                                ...
                                <li class="page-item">
                                    ...
                                    if($_SESSION["adminRole"] == "Super_Admin"){
                                        ...
                                        $sql = "SELECT COUNT(*) FROM waitinglist WHERE applicationStatus = 'Pending_Confirmation' AND siteCity = '$adminSiteName'";
                                    }
