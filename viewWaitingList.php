                    ...
                    <div class="col-md-9">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            if (isset($_GET["page"])) {
                                ...
                                $sql = "SELECT * FROM waitinglist WHERE siteCity = '$adminSiteName' ORDER BY id ASC LIMIT $ShowPostFrom,10";
                                $stmt=$ConnectingDB->query($sql);
                            }
                        ...
                        <div class="col-lg-4 offset-lg-4 col-md-4 offset-md-4 col-sm-12 mt-4">
                            <nav>
                                <ul class="pagination pagination-lg">
                                        ...
                                        if ( $Page>1 ) {?>
                                    <li class="page-item">
                                        <a class="page-link text-dark" href="viewWaitingList.php?page=<?php  echo $Page-1; ?>">
                                        <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                        <?php } }?>
