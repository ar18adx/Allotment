                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            if (isset($_GET["page"])) {
                                ...
                                if($_SESSION["adminRole"] == "Super_Admin"){
                                    ...
                                    $sql = "SELECT * FROM tenants WHERE siteCity = '$adminSiteName' ";
                                }
                                ...
                                if($_SESSION["adminRole"] == "Super_Admin"){
                                    ...
                                    $sql = "SELECT * FROM tenants WHERE siteCity = '$adminSiteName' ORDER BY id LIMIT $ShowPostFrom,10";
                                }
                            ...
                            <tbody>
                                ...
                                <?php }?>
                                <td><a class="btn btn-success" href="adminSendMsg.php?tenantId=<?php echo $tenantId; ?>" role="button">Send Message</a></td>
